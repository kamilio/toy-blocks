...
class AudioAmplifier:
    ...
    def __init__(self, data_pin, amp_type=PAM8403, shutdown_pin=None, 
                 sample_rate=44100, volume=50):
    ...
    async def _monitor(self):
        ...
        while self._running:
            ...
            if was_playing and not self._playing and self._current_sample_idx > 0:
                playback_completed = (self._current_audio_data and 
                                     self._current_sample_idx >= len(self._current_audio_data))
